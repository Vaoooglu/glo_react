...
class Slider extends React.Component {
	constructor (props){
		...
		renderDots(){
			return this.state.slides.map((item,index) => (
				<li
				className={this.isActiveDot(index)+' dots'}
				key={index}
				ref="dots"
			...
			return(
				<div>
					<button
							...
							onClick={this.prevOne}><svg fill="#FFFFFF" width="50" height="50" viewBox="0 0 24 24">
						...
						<button
							...
							onClick={this.nextOne}><svg fill="#FFFFFF" height="50" viewBox="0 0 24 24" width="50">
